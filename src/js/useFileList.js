 ...
 */
export const getFilesBySubmission = async ({ case_processes_id, case_id, submission_page, special }) => {
  try {
    // 验证必填参数
    ...
    // 发送GET请求
    const response = await fetch(`http://q7e69a6c.natappfree.cc/api/files/list-by-submission?${queryParams.toString()}`, {
      method: 'GET',
      headers: {
