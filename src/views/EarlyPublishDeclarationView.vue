<template>
  <div class="early-publish-declaration">
    ...
    <div class="btn-group">
      ...
      <el-button type="primary" @click="executeIdQuery">查询id</el-button>
    </div>
        ...
        <el-row :gutter="20">
          <el-col :span="8">
            <el-form-item label="提案名称:">
              <el-input v-model="caseInfo.proposalName" placeholder="请输入提案名称" :disabled="true"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="案件号:">
              <el-input v-model="caseInfo.projectNo" placeholder="请输入案件号" :disabled="true"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="申请号:">
              <el-input v-model="caseInfo.applicationNumber" placeholder="请输入申请号" :disabled="true"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20">
          <el-col :span="8">
            <el-form-item label="案件名称:">
              <el-input v-model="caseInfo.inventionName" placeholder="请输入案件名称" :disabled="true"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="案件状态:">
              <el-select v-model="caseInfo.caseStatus" placeholder="请选择" :disabled="true">
                ...
                <el-option v-for="option in selectOptions.caseStatuses" :key="option.value" :value="option.value" :label="option.label"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="申请类型:">
              <el-select v-model="caseInfo.applicationType" placeholder="请选择" :disabled="true">
                <el-option label="请选择" value=""></el-option>
                <el-option v-for="option in selectOptions.businessTypes" :key="option.value" :value="option.value" :label="option.label"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20">
          <el-col :span="8">
            <el-form-item label="官方期限:">
              <el-input v-model="caseInfo.officialDeadline" placeholder="请输入官方期限" :disabled="true"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
          ...
          <el-col :span="8">
            <el-form-item label="客户期限:">
              <el-input v-model="caseInfo.clientDeadline" placeholder="请输入客户期限" :disabled="true"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20">
          <el-col :span="8">
            <el-form-item label="处理事项:">
              <el-input v-model="caseInfo.processItem" placeholder="请输入处理事项" :disabled="true"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="业务人员:">
              <el-select v-model="caseInfo.businessPerson" placeholder="请选择" :disabled="true">
                <el-option label="请选择" value=""></el-option>
                <el-option v-for="option in selectOptions.personnel" :key="option.value" :value="option.value" :label="option.label"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="代理机构:">
              <el-select v-model="caseInfo.organizationName" placeholder="请选择" :disabled="true">
                <el-option label="请选择" value=""></el-option>
                <el-option v-for="option in selectOptions.organizations" :key="option.value" :value="option.value" :label="option.label"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20">
          <el-col :span="8">
            <el-form-item label="双报案件:">
              <el-input v-model="caseInfo.doubleReport" placeholder="请输入双报案件" :disabled="true"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="递交类型:">
              <el-input v-model="caseInfo.submissionType" placeholder="请输入递交类型" readonly :disabled="true"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
        ...
        <el-row :gutter="20">
          <el-col :span="8">
            <el-form-item label="案件ID:">
              <el-input v-model="caseInfo.caseId" placeholder="请输入案件ID" :disabled="true"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="处理事项ID:">
              <el-input v-model="caseInfo.processItemId" placeholder="请输入处理事项ID" :disabled="true"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
            ...
            <el-col :span="6">
              <el-form-item label="递交类型:">
                <el-select v-model="requestContent.submissionType" placeholder="请选择">
                  <el-option label="请选择" value=""></el-option>
                  <el-option v-for="option in selectOptions.submissionTypes" :key="option.value" :value="option.value" :label="option.label"></el-option>
                </el-select>
              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item label="文件类型:">
                <el-select v-model="requestContent.fileType" placeholder="请选择">
                  <el-option label="请选择" value=""></el-option>
                  <el-option v-for="option in selectOptions.fileTypes" :key="option.value" :value="option.value" :label="option.label"></el-option>
                </el-select>
              </el-form-item>
            </el-col>
            <el-col :span="6">
        ...
        <div class="declaration-row">
          <el-form-item>
            <el-radio-group v-model="requestContent.declaration">
              <el-radio :value="true">根据专利法第34条的规定,请求早日公布上述发明专利申请。</el-radio>
            </el-radio-group>
          </el-form-item>
        </div>
      </div>
    ...
    >
      <div style="padding: 20px;">
        <el-form :model="deleteForm" label-width="100px">
          ...
          <el-form-item label="处理事项ID:">
            <el-input
              v-model="deleteForm.caseProcessesId"
...
// 提前公布声明相关API
const getEarlyPublicationCaseInfo = (id: string) => apiCall(`/early-publication/${id}`, {
  id: 0, createTime: '', updateTime: '', recordNumber: '', submissionType: ''
})
...
const getEarlyPublicationByCase = async (caseId: string, caseProcessesId: string) => {
  try {
    const response = await fetch(`${API_BASE_URL}/early-publication/by-case?case_id=${caseId}&case_processes_id=${caseProcessesId}`)
    if (!response.ok) throw new Error(`HTTP error! status: ${response.status}`)
...
const loadCaseInfo = async () => {
  ...
  try {
    ...
    caseInfo.applicationType = summary.applicationType != null ? Number(summary.applicationType) : 0
...
const saveEarlyPublicationByCase = async () => {
  try {
    ...
    console.log('📤 完整URL:', `${API_BASE_URL}/early-publication/save?case_processes_id=${caseProcessesIdLong}&case_id=${caseIdLong}&submission_page=提前公布`)

    // 详细分析URL参数
    console.log('🔗 URL参数分析:')
    console.log('  - case_processes_id:', caseProcessesIdLong, '(类型:', typeof caseProcessesIdLong, ')')
    ...
    const response = await fetch(`${API_BASE_URL}/early-publication/save?case_processes_id=${caseProcessesIdLong}&case_id=${caseIdLong}&submission_page=提前公布`, {
      method: 'POST',
...
const executeIdQuery = async () => {
  ...
  try {
    // 使用新的查询接口
    const data = await getEarlyPublicationByCase(caseInfo.caseId.trim(), caseInfo.processItemId.trim())
...
const executeSubmit = async () => {
  try {
    ...
    // 规范并收集必要字段，保证后端能识别
    const businessType = Number.isInteger(caseInfo.applicationType) ? caseInfo.applicationType as number : 0
    const fileType = typeof requestContent.fileType === 'number' ? (requestContent.fileType as number) : 0
    ...
    const nameOfOrganization = (caseInfo.organizationName || '').trim() || '成都睿道专利代理事务所（普通合伙）'
    ...
    // 检查响应类型并记录日志
    if (type.includes('application/zip') || blob.type.includes('application/zip') || filename.endsWith('.zip')) {
