...
const submitCostRelief = async () => {
  try {
    ...
    const businessTypeNum = Number.isFinite(Number(formData.businessType)) ? Number(formData.businessType) : 1
    ...
    const fullUrl = 'http://47.108.144.113:9111/api/word/costRelief/xml' + (query ? '?' + query : '')
    ...
    const curl =
      ...
      ' -F "rateReliefString=' + encodeURIComponent(JSON.stringify(rateReliefString)) + '"' +
      ' -F "customerName=' + encodeURIComponent(customerNameToSend) + '"'
    console.log('🐚 cURL 复现:\n' + curl)
...
onMounted(() => {
  ...
  getCaseInfo(caseIdToUse)
    .then((info: any) => {
      ...
      } else if (info?.priorityExamination === 1 || info?.priorityExamination === '1' || info?.priorityExamination === true) {
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="8">
          <el-form-item label="案件状态:">
            <el-select v-model="formData.caseStatus" placeholder="请选择" filterable allow-create default-first-option clearable style="width: 100%;" disabled>
        ...
        <el-col :span="8">
          <el-form-item label="申请类型:">
            <el-select v-model="formData.businessType" placeholder="请选择" clearable style="width: 100%;" disabled>
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="8">
          <el-form-item label="内部期限:">
            <el-select v-model="formData.internalDeadline" placeholder="请输入或选择" filterable allow-create default-first-option clearable style="width: 100%;" disabled>
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="8">
          <el-form-item label="业务人员:">
            <el-select v-model="formData.businessPerson" placeholder="请输入或选择" filterable allow-create default-first-option clearable style="width: 100%;" disabled>
        ...
        <el-col :span="8">
          <el-form-item label="代理机构:">
            <el-select v-model="formData.nameOfOrganization" placeholder="请输入或选择" filterable allow-create default-first-option clearable style="width: 100%;" disabled>
              <el-option label="成都睿道专利代理事务所（普通合伙）" value="成都睿道专利代理事务所（普通合伙）"></el-option>
            </el-select>
          </el-form-item>
        </el-col>
      </el-row>
    ...
    <el-tabs v-model="activeTab">
      <el-tab-pane label="请求书" name="request">
        ...
        <div class="declaration-row">
          <el-form-item>
            <span>申请人或专利权人</span>
            <el-input v-model="formData.applicant_or_patentee" class="underline-input" style="width: 200px; margin-left: 10px;"></el-input>
          </el-form-item>
        </div>
        <div class="declaration-row">
          <el-form-item>
        ...
        <div class="declaration-row">
          <el-form-item>
            ...
            <el-input v-model="formData.filed_proof_number" class="underline-input" style="width: 200px; margin-left: 10px;" placeholder="请输入备案编号"></el-input>
          </el-form-item>
        </div>
      </el-tab-pane>
